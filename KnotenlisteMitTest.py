...
def checkKnotenListeFürEineEbene(df_ebene,erwartet):
    val=knotenliste_für_eine_ebene_erstellen(df_ebene)
    assert val==erwartet

def test_knotenliste_für_eine_ebene():
    checkKnotenListeFürEineEbene(1,1)
