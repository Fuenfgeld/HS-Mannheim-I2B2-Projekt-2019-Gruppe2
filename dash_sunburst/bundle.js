window.dash_sunburst = function (n) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.Sunburst = void 0;
    var r = function (n) {
        ...
        return function (n, t) {
            ...
            key: "componentDidMount", value: function () {
                ...
                this.sunburst = new a.default(this.el, this.props, function (t) {
                    var e = n.props.setProps, r = t.selectedPath;
                    e ? e({selectedPath: r}) : n.setState({selectedPath: r})
                })
            }
        }, {
            ...
            key: "render", value: function () {
                ...
                return u.default.createElement("div", {
                    id: this.props.id, ref: function (t) {
                        n.el = t
                    }
                })
            }
    ...
    t.default = c, c.defaultProps = {interactive: !0}, c.propTypes = {
        id: o.default.string,
    ...
    var o = 600, a = 500, l = 10, c = 20, f = 750, s = u.default.format(",.3g"), h = 2 * Math.PI;
    ...
    var g = {
        ...
        function n(t, e, r) {
            ...
            var i = this;
            i.update = i.update.bind(i), i._update = i._update.bind(i), i.svg = u.default.select(t).append("svg"), i.pathGroup = i.svg.append("g"), i.textGroup = i.svg.append("g").style("pointer-events", "none"), i.angularScale = u.default.scale.linear().range([0, h]), i.radialScale = u.default.scale.sqrt(), i.colorScale = u.default.scale.category20d(), i.partition = u.default.layout.partition().value(function (n) {
        ...
        return i(n, [{
            ...
            key: "_update", value: function (n) {
                var t = this, e = t.figure, i = n.width || o, p = n.height || a, d = !1 !== n.interactive,
                    x = n.padding || l, M = n.innerRadius || c, b = n.transitionDuration || f, _ = n.data,
                    w = n.dataVersion, S = n.selectedPath || [], k = t.figure = {
                        width: i,
                        height: p,
                        interactive: d,
                        padding: x,
                        ...
                        return "rotate(" + ((360 * T(n) / h + (function (n) {
                            var e = t.angularScale(n.x + n.dx) - t.angularScale(n.x), r = t.radialScale(n.y),
                        ...
                        return {x: n.x, dx: n.dx, y: n.y, dy: n.dy}
                    };
                ...
                var j = function (n) {
                    ...
                    r && (n.enter().append("path").style({stroke: "#A9E2F3", strokeWidth: 1}).on("click", function (n) {
                ...
                }, U = Promise.resolve(), F = function (n, t) {
                    var e = "Version", i = {}, u = !1;
                ...
                if (!F) return U;
                var H = F.width || F.height || F.padding, I = F.data, Y = t.rootName, V = t.rootName = _.name,
                    Z = t.selectedPath, X = t.selectedPath = S.slice();
                H && function () {
                    t.radius = Math.min(p, i) / 2 - x, t.svg.attr({width: i, height: p});
                    var n = "translate(" + i / 2 + "," + p / 2 + ")";
                    t.pathGroup.attr("transform", n), t.textGroup.attr("transform", n)
                }();
                var $ = t.pathGroup.selectAll("path"), B = t.textGroup.selectAll("text");
                ...
                var J = t.initialized && V === Y && function (n, t) {
                    for (var e = Math.min(n.length, t.length), r = 0; r < e; r++) if (n[r] !== t[r]) return !1;
                    return !0
                }(Z, X) && (!I || m(e.data, X));
    ...
    function m(n, t) {
        ...
        for (var e = void 0, r = 0; r < n.children.length; r++) if ((e = n.children[r]).name === t[0]) return m(e, t.slice(1));
        return !1
    }
    ...
    !function () {
        ...
        if (Date.now || (Date.now = function () {
            ...
            var s = this.Element.prototype, h = s.setAttribute, p = s.setAttributeNS,
                g = this.CSSStyleDeclaration.prototype, d = g.setProperty;
        ...
        u.ascending = v, u.descending = function (n, t) {
            ...
            if (1 === arguments.length) for (; ++a < i;) m(e = y(n[a])) && (o += (r = e - u) * (e - (u += r / ++l))); else for (; ++a < i;) m(e = y(t.call(n, n[a], a))) && (o += (r = e - u) * (e - (u += r / ++l)));
            if (l > 1) return o / (l - 1)
        ...
        w(S, {
            has: C, get: function (n) {
                return this._[E(n)]
            }, set: function (n, t) {
                return this._[E(n)] = t
            }, remove: T, keys: z, values: function () {
                var n = [];
                for (var t in this._) n.push(this._[t]);
                return n
            }, entries: function () {
                var n = [];
                for (var t in this._) n.push({key: A(t), value: this._[t]});
                return n
            ...
            has: C, add: function (n) {
                return this._[E(n += "")] = !0, n
            }, remove: T, values: z, size: q, empty: L, forEach: function (n) {
        ...
        var Z = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g, X = {}.__proto__ ? function (n, t) {
            n.__proto__ = t
        } : function (n, t) {
        ...
        var nn = "http://www.w3.org/1999/xhtml", tn = {
        ...
        u.ns = {
            ...
            if (arguments.length < 2) {
                if ("string" == typeof n) {
                    var e = this.node(), r = (n = on(n)).length, i = -1;
                    if (t = e.classList) {
                        for (; ++i < r;) if (!t.contains(n[i])) return !1
                    } else for (t = e.getAttribute("class"); ++i < r;) if (!un(n[i]).test(t)) return !1;
                    return !0
                }
        ...
        function Sn(n) {
            var t = ".dragsuppress-" + ++wn, e = "click" + t,
        ...
        u.touch = function (n, t, e) {
            if (arguments.length < 3 && (e = t, t = Y().changedTouches), t) for (var r, i = 0, u = t.length; i < u; ++i) if ((r = t[i]).identifier === e) return Nn(n, r)
        }, u.behavior.drag = function () {
            var n = V(i, "drag", "dragstart", "dragend"), t = null, e = o(U, u.mouse, f, "mousemove", "mouseup"),
            ...
            function o(e, r, i, o, a) {
                return function () {
                    var l, c = u.event.target.correspondingElement || u.event.target, f = this.parentNode,
                        s = n.of(this, arguments), h = 0, p = e(), g = ".drag" + (null == p ? "" : "-" + p),
                        d = u.select(i(c)).on(o + g, function () {
                            ...
                            if (!r(f, p)) return;
                            d.on(o + g, null).on(a + g, null), v(h), s({type: "dragend"})
                        }), v = Sn(c), y = r(f, p);
                    l = t ? [(l = t.apply(this, arguments)).x - y[0], l.y - y[1]] : [0, 0], s({type: "dragstart"})
                }
            }
        ...
        var An = 1e-6, Cn = An * An, Tn = Math.PI, zn = 2 * Tn, qn = zn - An, Ln = Tn / 2, Pn = Tn / 180, Rn = 180 / Tn;
        ...
        u.interpolateZoom = function (n, t) {
            ...
            if (h < Cn) r = Math.log(c / o) / In, e = function (n) {
                ...
                var p = Math.sqrt(h), g = (c * c - o * o + 4 * h) / (2 * o * 2 * p),
                    d = (c * c - o * o - 4 * h) / (2 * c * 2 * p), v = Math.log(Math.sqrt(g * g + 1) - g),
                    y = Math.log(Math.sqrt(d * d + 1) - d);
                r = (y - v) / In, e = function (n) {
                    var t = n * r, e = Fn(v), a = o / (2 * p) * (e * function (n) {
            ...
            var n, t, e, r, i, o, a, c, s, h = {x: 0, y: 0, k: 1}, p = [960, 500], g = Zn, d = 250, v = 0,
                y = "mousedown.zoom", m = "mousemove.zoom", x = "mouseup.zoom", M = "touchstart.zoom",
            ...
            function T(n) {
                --v || (n({type: "zoomend"}), t = null)
            }

            function z() {
                var n = this, t = b.of(n, arguments), e = 0, r = u.select(f(n)).on(m, function () {
                    e = 1, k(u.mouse(n), i), C(t)
                }).on(x, function () {
                    r.on(m, null).on(x, null), o(e), T(t)
                }), i = w(u.mouse(n)), o = Sn(n);
                pa.call(n), A(t)
            }

            function q() {
                var n, t = this, e = b.of(t, arguments), r = {}, o = 0,
                    a = ".zoom-" + u.event.changedTouches[0].identifier, l = "touchmove" + a, c = "touchend" + a,
                    f = [], s = u.select(t), p = Sn(t);
                ...
                function v() {
                    ...
                    pa.call(t);
                    for (var h = 0, p = s.length; h < p; ++h, f = null) if (c = s[h], f = r[c.identifier]) {
                        if (l) break;
                        a = c, l = f
                    }
                    if (f) {
                        var g = (g = c[0] - a[0]) * g + (g = c[1] - a[1]) * g, d = o && Math.sqrt(g / o);
            ...
            return Vn || (Vn = "onwheel" in l ? (Yn = function () {
                ...
                return arguments.length ? (a = n, o = n.copy(), h = {x: 0, y: 0, k: 1}, _) : a
            }, _.y = function (n) {
                return arguments.length ? (s = n, c = n.copy(), h = {x: 0, y: 0, k: 1}, _) : s
            }, u.rebind(_, b, "on")
        };
        var Yn, Vn, Zn = [0, 1 / 0];
        ...
        var nt = 18, tt = .95047, et = 1, rt = 1.08883, it = Qn.prototype = new Xn;
        ...
        function wt(n, t, e, r) {
            var i = {}, o = u.dispatch("beforesend", "progress", "load", "error"), l = {}, c = new XMLHttpRequest,
                f = null;
            ...
            return !this.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload" in c ? c.onload = c.onerror = s : c.onreadystatechange = function () {
                ...
                if (2 === arguments.length && "function" == typeof r && (u = r, r = null), c.open(e, n, !0), null == t || "accept" in l || (l.accept = t + ",*/*"), c.setRequestHeader) for (var a in l) c.setRequestHeader(a, l[a]);
        ...
        Mt.forEach(function (n, t) {
            ...
            return i.parse = function (n, t) {
                ...
                var e, i, u = {}, o = {}, a = [], l = n.length, c = 0, f = 0;
                ...
                function s() {
                    ...
                    for (; c < l;) {
                        var a, f = 1;
                        if (10 === (a = n.charCodeAt(c++))) i = !0; else if (13 === a) i = !0, 10 === n.charCodeAt(c) && (++c, ++f); else if (a !== r) continue;
        ...
        function ce(n) {
            var t = n.getTimezoneOffset(), e = t > 0 ? "-" : "+", r = _(t) / 60 | 0, i = _(t) % 60;
        ...
        u.locale = function (n) {
            return {
                numberFormat: function (n) {
                    ...
                    return function (n) {
                        var e = Rt.exec(n), r = e[1] || " ", a = e[2] || ">", l = e[3] || "-", c = e[4] || "", f = e[5],
                            s = +e[6], h = e[7], p = e[8], g = e[9], d = 1, v = "", y = "", m = !1, x = !0;
                ...
                }(n), timeFormat: function (n) {
                    var t = n.dateTime, e = n.date, r = n.time, i = n.periods, o = n.days, a = n.shortDays,
                        l = n.months, c = n.shortMonths;
                    ...
                    function f(n) {
                        ...
                        return e.parse = function (t) {
                            ...
                            var r = null != e.Z && Ut !== Ft, i = new (r ? Ft : Ut);
                    ...
                    var h = u.map(), p = Bt(o), g = Gt(o), d = Bt(a), v = Gt(a), y = Bt(l), m = Gt(l), x = Bt(c),
                        M = Gt(c);
                    ...
                    var b = {
                        ...
                        }, d: re, e: re, H: ue, I: ue, j: ie, L: le, m: ee, M: oe, p: function (n, t, e) {
                            var r = h.get(t.slice(e, e += 2).toLowerCase());
                            return null == r ? -1 : (n.p = r, e)
                        }, S: ae, U: Wt, w: Jt, W: Kt, x: function (n, t, e) {
        ...
        var be, _e, we, Se, ke, Ne, Ee, Ae, Ce, Te, ze, qe, Le = new pe, Pe = {
            sphere: function () {
                be += 4 * Tn
        ...
        function Re() {
            ...
            function u(n, t) {
                t = t * Pn / 2 + Tn / 4;
                var u = (n *= Pn) - e, o = u >= 0 ? 1 : -1, a = o * u, l = Math.cos(t), c = Math.sin(t), f = i * c,
                    s = r * l + f * Math.cos(a), h = f * o * Math.sin(a);
        ...
        u.geo.bounds = function () {
            var n, t, e, r, i, o, a, l, c, f, s, h = {
                point: p, lineStart: d, lineEnd: v, polygonStart: function () {
            ...
            function g(u, o) {
                var a = De([u * Pn, o * Pn]);
                if (l) {
                    var c = Oe(l, a), f = Oe([c[1], -c[0], 0], c);
                    He(f), f = Ie(f);
                    var s = u - i, h = s > 0 ? 1 : -1, g = f[0] * Rn * h, d = _(s) > 180;
                    if (d ^ (h * i < g && g < h * u)) (v = f[1] * Rn) > r && (r = v); else if (d ^ (h * i < (g = (g + 360) % 360 - 180) && g < h * u)) {
                        var v;
                        (v = -f[1] * Rn) < t && (t = v)
        ...
        function $e() {
            ...
            function r(r, i) {
                r *= Pn;
                var u = Math.cos(i *= Pn), o = u * Math.cos(r), a = u * Math.sin(r), l = Math.sin(i),
        ...
        function Ge() {
            ...
            function u(n, t) {
                n *= Pn;
                var u = Math.cos(t *= Pn), o = u * Math.cos(n), a = u * Math.sin(n), l = Math.sin(t), c = r * l - i * a,
                    f = i * o - e * l, s = e * a - r * o, h = Math.sqrt(c * c + f * f + s * s),
                    p = e * o + r * a + i * l, g = h && -On(p) / h, d = Math.atan2(h, p);
        ...
        function tr(n, t, e, r) {
            return function (i, o) {
                var a, l = t(o), c = i.invert(r[0], r[1]), f = {
                    point: s, lineStart: p, lineEnd: g, polygonStart: function () {
                        ...
                        var n = function (n, t) {
                            ...
                            for (var a = 0, l = t.length; a < l; ++a) {
                                ...
                                if (f) for (var s = c[0], h = s[0], p = s[1] / 2 + Tn / 4, g = Math.sin(p), d = Math.cos(p), v = 1; ;) {
                                    v === f && (v = 0);
                                    var y = (n = c[v])[0], m = n[1] / 2 + Tn / 4, x = Math.sin(m), M = Math.cos(m),
                                        b = y - h, _ = b >= 0 ? 1 : -1, w = _ * b, S = w > Tn, k = g * x;
                ...
                function _() {
                    ...
                    if (v.pop(), d.push(v), v = null, r) if (1 & t) {
                        var i, u = -1;
        ...
        var ur = tr(We, function (n) {
            ...
            var i;
            if (null == n) i = e * Ln, r.point(-Tn, i), r.point(0, i), r.point(Tn, i), r.point(Tn, 0), r.point(Tn, -i), r.point(0, -i), r.point(-Tn, -i), r.point(-Tn, 0), r.point(-Tn, i); else if (_(n[0] - t[0]) > An) {
                var u = n[0] < t[0] ? Tn : -Tn;
                    ...
                    if (u = e - l, h || !(u < 0)) {
                        ...
                        if (u = t - c, p || !(u > 0)) {
                            ...
                            if (u = r - c, p || !(u < 0)) {
                                ...
                                return f > 0 && (i.a = {x: l + f * h, y: c + f * p}), s < 1 && (i.b = {
                                    x: l + s * h,
                                    y: c + s * p
                                }), i
                            }
        ...
        function lr(n, t, e, r) {
            return function (l) {
                var c, f, s, h, p, g, d, v, y, m, x, M = l, b = rr(), _ = or(n, t, e, r), w = {
                    point: N, lineStart: function () {
                        ...
                        l = M, c = u.merge(c);
                        var t = function (n) {
                            for (var t = 0, e = f.length, r = n[1], i = 0; i < e; ++i) for (var u, o = 1, a = f[i], l = a.length, c = a[0]; o < l; ++o) u = a[o], c[1] <= r ? u[1] > r && jn(c, u, n) > 0 && ++t : u[1] <= r && jn(c, u, n) < 0 && --t, c = u;
                            return 0 !== t
                        }([n, r]), e = x && t, i = c.length;
                ...
                function S(u, o, l, c) {
                    var f = 0, s = 0;
                    if (null == u || (f = i(u, l)) !== (s = i(o, l)) || a(u, o) < 0 ^ l > 0) do {
                        c.point(0 === f || 3 === f ? n : e, f > 1 ? r : t)
                    } while ((f = (f + l + 4) % 4) !== s); else c.point(o[0], o[1])
                }
                ...
                function E(n, t) {
                    ...
                    if (f && s.push([n, t]), m) h = n, p = t, g = e, m = !1, e && (l.lineStart(), l.point(n, t)); else if (e && y) l.point(n, t); else {
                        var r = {a: {x: d, y: v}, b: {x: n, y: t}};
        ...
        u.geo.clipExtent = function () {
            var n, t, e, r, i, u, o = {
                stream: function (n) {
                    ...
                    return arguments.length ? (u = lr(n = +a[0][0], t = +a[0][1], e = +a[1][0], r = +a[1][1]), i && (i.valid = !1, i = null), o) : [[n, t], [e, r]]
                }
            };
            ...
            var n, t, e, r, i = u.geo.albers(),
                ...
                a = u.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {
                    point: function (t, e) {
                        n = [t, e]
                    }
                };
            ...
            return c.invert = function (n) {
                ...
                return t = i.translate(n).clipExtent([[f - .455 * u, s - .238 * u], [f + .455 * u, s + .238 * u]]).stream(l).point, e = o.translate([f - .307 * u, s + .201 * u]).clipExtent([[f - .425 * u + An, s + .12 * u + An], [f - .214 * u - An, s + .234 * u - An]]).stream(l).point, r = a.translate([f - .205 * u, s + .212 * u]).clipExtent([[f - .214 * u + An, s + .166 * u + An], [f - .115 * u - An, s + .234 * u - An]]).stream(l).point, c
            }, c.scale(1070)
        };
        ...
        var xr = {
            point: function (n, t) {
                ...
                t < gr && (gr = t);
                t > vr && (vr = t)
            }, lineStart: U, lineEnd: U, polygonStart: U, polygonEnd: U
        };
        ...
        var br, _r = {
            point: wr, lineStart: Sr, lineEnd: kr, polygonStart: function () {
                _r.lineStart = Nr
            }, polygonEnd: function () {
        ...
        function Er(n) {
            ...
            function u(r, i, o, a, l, c, f, s, h, p, g, d, v, y) {
                var m = f - r, x = s - i, M = m * m + x * x;
                if (M > 4 * t && v--) {
                    var b = a + p, w = l + g, S = c + d, k = Math.sqrt(b * b + w * w + S * S), N = Math.asin(S /= k),
                        E = _(_(S) - 1) < An || _(o - h) < An ? (o + h) / 2 : Math.atan2(w, b), A = n(E, N), C = A[0],
                        T = A[1], z = C - r, q = T - i, L = x * z - m * q;
        ...
        function zr(n) {
            ...
            }), c = 150, f = 480, s = 250, h = 0, p = 0, g = 0, d = 0, v = 0, y = ur, m = R, x = null, M = null;
            ...
            return b.stream = function (n) {
                ...
                return arguments.length ? (y = null == n ? (x = n, ur) : function (n) {
                    var t = Math.cos(n), e = t > 0, r = _(t) > An;
                    return tr(i, function (n) {
                        ...
                        return {
                            lineStart: function () {
                                ...
                                if (!t && (c = l = d) && n.lineStart(), d !== l && (p = u(t, g), (Ye(t, p) || Ye(g, p)) && (g[0] += An, g[1] += An, d = i(g[0], g[1]))), d !== l) f = 0, d ? (n.lineStart(), p = u(g, t), n.point(p[0], p[1])) : (p = u(t, g), n.point(p[0], p[1]), n.lineEnd()), t = p; else if (r && t && e ^ d) {
                                    var y;
                    ...
                    function u(n, e, r) {
                        var i = [1, 0, 0], u = Oe(De(n), De(e)), o = je(u, u), a = u[0], l = o - a * a;
                        if (!l) return !r && n;
                        var c = t * o / l, f = -t * a / l, s = Oe(i, u), h = Fe(i, c);
                        Ue(h, Fe(u, f));
                        var p = s, g = je(h, p), d = je(p, p), v = g * g - d * (je(h, h) - 1);
                        if (!(v < 0)) {
                            var y = Math.sqrt(v), m = Fe(p, (-g - y) / d);
                            if (Ue(m, h), m = Ie(m), !r) return m;
                            var x, M = n[0], b = e[0], w = n[1], S = e[1];
                            b < M && (x = M, M = b, b = x);
                            var k = b - M, N = _(k - Tn) < An;
            ...
            }, u.rebind(b, l, "precision"), function () {
        ...
        u.geo.path = function () {
            ...
            return a.area = function (n) {
                ...
                return dr = vr = -(pr = gr = 1 / 0), u.geo.stream(n, e(xr)), [[pr, gr], [dr, vr]]
            ...
            function i() {
                var n = "function" == typeof e ? e.apply(this, arguments) : e, r = Rr(-n[0] * Pn, -n[1] * Pn, 0).invert,
                    i = [];
            ...
            var e, r = (t[0] - n[0]) * Pn, i = n[1] * Pn, u = t[1] * Pn, o = Math.sin(r), a = Math.cos(r),
                l = Math.sin(i), c = Math.cos(i), f = Math.sin(u), s = Math.cos(u);
            return Math.atan2(Math.sqrt((e = s * o) * e + (e = c * f - l * s * a) * e), l * f + c * s * a)
        }, u.geo.graticule = function () {
            var n, t, e, r, i, o, a, l, c, f, s, h, p = 10, g = p, d = 90, v = 360, y = 2.5;
            ...
            return m.lines = function () {
                ...
                return arguments.length ? (r = +n[0][0], e = +n[1][0], l = +n[0][1], a = +n[1][1], r > e && (n = r, r = e, e = n), l > a && (n = l, l = a, a = n), m.precision(y)) : [[r, l], [e, a]]
            ...
            }, m.majorExtent([[-180, -90 + An], [180, 90 - An]]).minorExtent([[-180, -80 - An], [180, 80 + An]])
        }, u.geo.greatArc = function () {
            var n, t, e = Yr, r = Vr;

            function i() {
                return {type: "LineString", coordinates: [n || e.apply(this, arguments), t || r.apply(this, arguments)]}
            }
            ...
            return function (n, t, e, r) {
                var i = Math.cos(t), u = Math.sin(t), o = Math.cos(r), a = Math.sin(r), l = i * Math.cos(n),
                    ...
                    h = 2 * Math.asin(Math.sqrt(Hn(r - t) + i * o * Hn(e - n))), p = 1 / Math.sin(h),
                    g = h ? function (n) {
        ...
        var Zr = {
            sphere: U, point: U, lineStart: function () {
                var n, t, e;

                function r(r, i) {
                    var u = Math.sin(i *= Pn), o = Math.cos(i), a = _((r *= Pn) - n), l = Math.cos(a);
            ...
            }, lineEnd: U, polygonStart: U, polygonEnd: U
        };
        ...
        function Gr(n, t) {
            ...
            return o.invert = function (n, t) {
                var e = u - t, r = Dn(i) * Math.sqrt(n * n + e * e);
        ...
        function Qr(n) {
            var t, e = Tr(n), r = e.scale, i = e.translate, u = e.clipExtent;
        ...
        (u.geo.stereographic = function () {
            ...
            var n = Qr(ei), t = n.center, e = n.rotate;
        ...
        function bi(n) {
            for (var t, e, r, i, u = n.x, o = n.y, a = pi._; a;) if ((r = _i(a, o) - u) > An) a = a.L; else {
                if (!((i = u - wi(a, o)) > An)) {
            ...
            if (pi.insert(t, l), t || e) {
                ...
                if (e) {
                    Ei(t), Ei(e);
                    var c = t.site, f = c.x, s = c.y, h = n.x - f, p = n.y - s, g = e.site, d = g.x - f, v = g.y - s,
                        y = 2 * (h * v - p * d), m = h * h + p * p, x = d * d + v * v,
        ...
        function Ni(n) {
            ...
            if (t && e) {
                ...
                if (r !== u) {
                    var o = i.x, a = i.y, l = r.x - o, c = r.y - a, f = u.x - o, s = 2 * (l * (v = u.y - a) - c * f);
                    if (!(s >= -Cn)) {
                        var h = l * l + c * c, p = f * f + v * v, g = (v * h - c * p) / s, d = (l * p - f * h) / s,
                            v = d + a, y = yi.pop() || new function () {
                                Ri(this), this.x = this.y = this.arc = this.site = this.cy = null
                            };
                        y.arc = n, y.site = i, y.x = g + o, y.y = v + Math.sqrt(g * g + d * d), y.cy = v, n.circle = y;
                        for (var m = null, x = di._; x;) if (y.y < x.y || y.y === x.y && y.x <= x.x) {
                            if (!x.L) {
                                m = x.P;
                                break
                            }
        ...
        function Ai(n, t) {
            ...
            } else if (i = y - (r = (h - g) / (d - p)) * v, r < -1 || r > 1) if (h > g) {
                if (u) {
                    if (u.y >= c) return
                } else u = {x: (l - i) / r, y: l};
                e = {x: (c - i) / r, y: c}
        ...
        function Ui(n, t) {
            ...
            for (si = [], hi = new Array(n.length), pi = new Pi, di = new Pi; ;) if (i = gi, u && (!i || u.y < i.y || u.y === i.y && u.x < i.x)) u.x === e && u.y === r || (hi[u.i] = new Si(u), bi(u), e = u.x, r = u.y), u = n.pop(); else {
                if (!i) break;
                Mi(i.arc)
            }
            t && (function (n) {
                ...
                for (var t, e, r, i, u, o, a, l, c, f, s = n[0][0], h = n[1][0], p = n[0][1], g = n[1][1], d = hi, v = d.length; v--;) if ((u = d[v]) && u.prepare()) for (l = (a = u.edges).length, o = 0; o < l;) r = (f = a[o].end()).x, i = f.y, t = (c = a[++o % l].start()).x, e = c.y, (_(r - t) > An || _(i - e) > An) && (a.splice(o, 0, new Li(zi(u.site, f, _(r - s) < An && g - i > An ? {
                    x: s,
                    y: _(t - s) < An ? e : g
                } : _(i - g) < An && h - r > An ? {
                    x: _(e - g) < An ? t : h,
                    ...
                    x: h,
                    y: _(t - h) < An ? e : p
                } : _(i - p) < An && r - s > An ? {x: _(e - p) < An ? t : s, y: p} : null), u.site, null)), ++l)
            }(t));
            var o = {cells: hi, edges: si};
        ...
        Si.prototype.prepare = function () {
            ...
            insert: function (n, t) {
                ...
                if (e = u ? o ? Oi(o) : u : o, i ? i.L === n ? i.L = e : i.R = e : this._ = e, u && o ? (r = e.C, e.C = n.C, e.L = u, u.U = e, e !== o ? (i = e.U, e.U = n.U, n = e.R, i.L = n, e.R = o, o.U = e) : (e.U = i, i = e, n = e.R)) : (r = n.C, n = e), n && (n.U = i), !r) if (n && n.C) n.C = !1; else {
                    do {
                        if (n === this._) break;
                        if (n === i.L) {
            ...
            var t = ri, e = ii, r = t, i = e, u = Hi;
            if (n) return o(n);

            function o(n) {
                var t = new Array(n.length), e = u[0][0], r = u[0][1], i = u[1][0], o = u[1][1];
                return Ui(a(n), u).cells.forEach(function (u, a) {
                    var l = u.edges, c = u.site;
                    (t[a] = l.length ? l.map(function (n) {
                        var t = n.start();
                        return [t.x, t.y]
                    }) : c.x >= e && c.x <= i && c.y >= r && c.y <= o ? [[e, o], [i, o], [i, r], [e, r]] : []).point = n[a]
                }), t
            }

            function a(n) {
                return n.map(function (n, t) {
                    return {x: Math.round(r(n, t) / An) * An, y: Math.round(i(n, t) / An) * An, i: t}
                })
            }
            ...
            return o.links = function (n) {
                ...
                return arguments.length ? o.clipExtent(n && [[0, 0], n]) : u === Hi ? null : u && u[1]
            }, o
        };
        ...
        function Bi(n, t) {
            var e, r, i, u = Gi.lastIndex = Ji.lastIndex = 0, o = -1, a = [], l = [];
            for (n += "", t += ""; (e = Gi.exec(n)) && (r = Ji.exec(t));) (i = r.index) > u && (i = t.slice(u, i), a[o] ? a[o] += i : a[++o] = i), (e = e[0]) === (r = r[0]) ? a[o] ? a[o] += r : a[++o] = r : (a[++o] = null, l.push({
                i: o,
                x: $i(e, r)
            })), u = Ji.lastIndex;
        ...
        u.geom.delaunay = function (n) {
            ...
            function l(n) {
                var l, c, f, s, h, p, g, d, v, y = bt(o), m = bt(a);
                if (null != t) p = t, g = e, d = r, v = i; else if (d = v = -(p = g = 1 / 0), c = [], f = [], h = n.length, u) for (s = 0; s < h; ++s) (l = n[s]).x < p && (p = l.x), l.y < g && (g = l.y), l.x > d && (d = l.x), l.y > v && (v = l.y), c.push(l.x), f.push(l.y); else for (s = 0; s < h; ++s) {
                    var x = +y(l = n[s], s), M = +m(l, s);
                ...
                function S(n, t, e, r, i, u, o, a) {
                    if (!isNaN(e) && !isNaN(r)) if (n.leaf) {
                        var l = n.x, c = n.y;
                        if (null != l) if (_(l - e) + _(c - r) < .01) k(n, t, e, r, i, u, o, a); else {
                            var f = n.point;
                    ...
                    return function (n, t, e, r, i, u, o) {
                        ...
                        return function n(c, f, s, h, p) {
                            if (!(f > u || s > o || h < r || p < i)) {
                                ...
                                for (var x = c.nodes, M = .5 * (f + h), b = .5 * (s + p), _ = (e >= b) << 1 | t >= M, w = _ + 4; _ < w; ++_) if (c = x[3 & _]) switch (3 & _) {
                                    case 0:
                                        n(c, f, s, M, b);
                                        break;
                                    case 1:
            ...
            return l.x = function (n) {
                ...
                return arguments.length ? (null == n ? t = e = r = i = null : (t = +n[0][0], e = +n[0][1], r = +n[1][0], i = +n[1][1]), l) : null == t ? null : [[t, e], [r, i]]
            }, l.size = function (n) {
        ...
        var Gi = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Ji = new RegExp(Gi.source, "g");
        ...
        var Qi = function () {
            ...
            in: R, out: eu, "in-out": ru, "out-in": function (n) {
                return ru(eu(n))
            }
        });
        ...
        function hu(n) {
            var t = [n.a, n.b], e = [n.c, n.d], r = gu(t), i = pu(t, e), u = gu(function (n, t, e) {
        ...
        u.ease = function (n) {
            ...
            return e = nu.get(e) || Qi, function (n) {
                return function (t) {
        ...
        var du = {a: 1, b: 0, c: 0, d: 1, e: 0, f: 0};
        ...
        function yu(n, t) {
            ...
            return n = u.transform(n), t = u.transform(t), function (n, t, e, r) {
                if (n[0] !== t[0] || n[1] !== t[1]) {
                    ...
                    r.push({i: i - 4, x: $i(n[0], t[0])}, {i: i - 2, x: $i(n[1], t[1])})
        ...
        function Mu(n) {
            for (var t = n.source, e = n.target, r = function (n, t) {
                if (n === t) return n;
                var e = bu(n), r = bu(t), i = e.pop(), u = r.pop(), o = null;
        ...
        u.interpolateTransform = yu, u.layout = {}, u.layout.bundle = function () {
            ...
            var n, t, e, r, i, o, a, l = {}, c = 0;

            function f() {
                var l, f, h, p, g, d = {}, v = [], y = u.range(r), m = [];
                for (n = [], t = [], l = 0, p = -1; ++p < r;) {
                ...
                for (i && y.sort(function (n, t) {
                    ...
                    for (h = f, g = -1; ++g < r;) {
                        var x = y[p], M = m[x][g], b = e[x][M], _ = f, w = f += b * l;
                        d[x + "-" + M] = {index: x, subindex: M, startAngle: _, endAngle: w, value: b}
                    }
                    t[x] = {index: x, startAngle: h, endAngle: f, value: v[x]}, f += c
                }
                for (p = -1; ++p < r;) for (g = p - 1; ++g < r;) {
                    var S = d[p + "-" + g], k = d[g + "-" + p];
                    (S.value || k.value) && n.push(S.value < k.value ? {source: k, target: S} : {source: S, target: k})
                }
                a && s()
            }
            ...
            var n, t, e, r, i, o, a = {}, l = u.dispatch("start", "tick", "end"), c = [1, 1], f = .9, s = Nu, h = Eu,
                p = -30, g = Au, d = .1, v = .64, y = [], m = [];
            ...
            return a.tick = function () {
                if ((e *= .99) < .005) return n = null, l.end({type: "end", alpha: e = 0}), !0;
                var t, a, s, h, g, v, M, b, _, w = y.length, S = m.length;
                ...
                if ((M = e * d) && (b = c[0] / 2, _ = c[1] / 2, a = -1, M)) for (; ++a < w;) (s = y[a]).x += (b - s.x) * M, s.y += (_ - s.y) * M;
                ...
                return arguments.length ? (t = +t, e ? t > 0 ? e = t : (n.c = null, n.t = NaN, n = null, l.end({
                    type: "end",
                    alpha: e = 0
                })) : t > 0 && (l.start({type: "start", alpha: e = t}), n = Ct(a.tick)), a) : e
            }, a.start = function () {
                var n, t, e, u = y.length, l = m.length, f = c[0], g = c[1];
                ...
                if (r = [], "function" == typeof s) for (n = 0; n < l; ++n) r[n] = +s.call(this, m[n], n); else for (n = 0; n < l; ++n) r[n] = s;
                if (i = [], "function" == typeof h) for (n = 0; n < l; ++n) i[n] = +h.call(this, m[n], n); else for (n = 0; n < l; ++n) i[n] = h;
        ...
        u.layout.hierarchy = function () {
            ...
            function r(i) {
                var u, o = [i], a = [];
                for (i.depth = 0; null != (u = o.pop());) if (a.push(u), (c = t.call(r, u, u.depth)) && (l = c.length)) {
            ...
            var n = Number, t = Du, e = 0, r = zn, i = 0;

            function o(a) {
                var l, c = a.length, f = a.map(function (t, e) {
                        return +n.call(o, t, e)
                    ...
                    g = p * (h < 0 ? -1 : 1), d = u.sum(f), v = d ? (h - c * g) / d : 0, y = u.range(c), m = [];
                return null != t && y.sort(t === Du ? function (n, t) {
                    return f[t] - f[n]
                } : function (n, e) {
                    return t(a[n], a[e])
                }), y.forEach(function (n) {
                    m[n] = {data: a[n], value: l = f[n], startAngle: s, endAngle: s += l * v + g, padAngle: p}
                }), m
            }
        ...
        u.layout.stack = function () {
            var n = R, t = Iu, e = Yu, r = Uu, i = ju, o = Ou;
            ...
            function a(l, c) {
                ...
                var p, g, d, v, y = e.call(a, s, c), m = f[0].length;
                for (d = 0; d < m; ++d) for (r.call(a, f[0][d], v = y[d], s[0][d][1]), g = 1; g < p; ++g) r.call(a, f[g][d], v += s[g - 1][d][1], s[g][d][1]);
                return l
            }
        ...
        var Fu = u.map({
            "inside-out": function (n) {
                var t, e, r = n.length, i = n.map(Vu), o = n.map(Zu), a = u.range(r).sort(function (n, t) {
                    return i[n] - i[t]
                }), l = 0, c = 0, f = [], s = [];
        ...
        function no(n) {
            if ((t = n.children) && (l = t.length)) {
                ...
                if (t.forEach(to), (e = t[0]).x = -e.r, e.y = 0, x(e), l > 1 && ((r = t[1]).x = r.r, r.y = 0, x(r), l > 2)) for (ro(e, r, i = t[2]), x(i), Wu(e, i), e._pack_prev = i, Wu(i, r), r = e._pack_next, u = 3; u < l; u++) {
                    ro(e, r, i = t[u]);
                    var p = 0, g = 1, d = 1;
                    for (o = r._pack_next; o !== r; o = o._pack_next, g++) if (Qu(o, i)) {
                        p = 1;
                        break
                    }
                    if (1 == p) for (a = e._pack_prev; a !== o._pack_prev && !Qu(a, i); a = a._pack_prev, d++) ;
                    p ? (g < d || g == d && r.r < e.r ? Ku(e, r = o) : Ku(e = a, r), u--) : (Wu(e, i), r = i, x(i))
                }
                var v = (c + f) / 2, y = (s + h) / 2, m = 0;
        ...
        function ro(n, t, e) {
            ...
            if (r && (i || u)) {
                var o = t.r + e.r, a = i * i + u * u, l = .5 + ((r *= r) - (o *= o)) / (2 * a),
        ...
        u.layout.histogram = function () {
            ...
            function i(i, o) {
                ...
                if (g > 0) for (o = -1; ++o < p;) (l = f[o]) >= s[0] && l <= s[1] && ((a = c[u.bisect(h, l, 1, g) - 1]).y += d, a.push(i[o]));
                return c
            }
            ...
            var n, t = u.layout.hierarchy().sort(Ju), e = 0, r = [1, 1];

            function i(i, u) {
                var o = t.call(this, i, u), a = o[0], l = r[0], c = r[1],
            ...
            var n = u.layout.hierarchy().sort(null).value(null), t = io, e = [1, 1], r = null;

            function i(i, u) {
                var c = n.call(this, i, u), f = c[0], s = function (n) {
                ...
                if (zu(s, o), s.parent.m = -s.z, Tu(s, a), r) Tu(f, l); else {
                    var h = f, p = f, g = f;
                    Tu(f, function (n) {
                        n.x < h.x && (h = n), n.x > p.x && (p = n), n.depth > g.depth && (g = n)
                    });
                    var d = t(h, p) / 2 - h.x, v = e[0] / (p.x + t(p, h) / 2 + d), y = e[1] / (g.depth || 1);
                    Tu(f, function (n) {
            ...
            var n = u.layout.hierarchy().sort(null).value(null), t = io, e = [1, 1], r = !1;

            function i(i, o) {
                var a, l = n.call(this, i, o), c = l[0], f = 0;
                zu(c, function (n) {
                    var e = n.children;
            ...
            var n, t = u.layout.hierarchy(), e = Math.round, r = [1, 1], i = null, o = co, a = !1, l = "squarify",
                c = .5 * (1 + Math.sqrt(5));
            ...
            function s(n) {
                var t = n.children;
                if (t && t.length) {
                    var e, r, i, u = o(n), a = [], c = t.slice(), h = 1 / 0,
                        d = "slice" === l ? u.dx : "dice" === l ? u.dy : "slice-dice" === l ? 1 & n.depth ? u.dy : u.dx : Math.min(u.dx, u.dy);
                    for (f(c, u.dx * u.dy / n.value), a.area = 0; (i = c.length) > 0;) a.push(e = c[i - 1]), a.area += e.area, "squarify" !== l || (r = p(a, d)) <= h ? (c.pop(), h = r) : (a.area -= a.pop().area, g(a, d, u, !1), d = Math.min(u.dx, u.dy), a.length = a.area = 0, h = 1 / 0);
            ...
            function g(n, t, r, i) {
                var u, o = -1, a = n.length, l = r.x, c = r.y, f = t ? e(n.area / t) : 0;
                if (t == r.dx) {
        ...
        var yo = {floor: R, ceil: R};

        function mo(n, t, e, r) {
            var i = [], o = [], a = 0, l = Math.min(n.length, t.length) - 1;
        ...
        function bo(n, t) {
            null == t && (t = 10);
            var e = so(n), r = e[1] - e[0], i = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10)), u = t / r * i;
        ...
        function wo(n, t, e) {
            ...
            if (e) {
                ...
                if (i.shift(), "s" === i[8]) {
                    ...
                    return i[7] || (i[7] = "." + ko(o.scale(r[2]))), i[8] = "f", e = u.format(i.join("")), function (n) {
        ...
        u.scale.linear = function () {
            return function n(t, e, r, i) {
                ...
                function a() {
                    var n = Math.min(t.length, e.length) > 2 ? mo : po, a = i ? xu : mu;
        ...
        u.scale.log = function () {
            return function n(t, e, r, i) {
                ...
                l.ticks = function () {
                    var n = so(i), t = [], u = n[0], l = n[1], c = Math.floor(o(u)), f = Math.ceil(o(l)),
                        s = e % 1 ? 2 : e;
                    if (isFinite(f - c)) {
                        if (r) {
        ...
        u.scale.pow = function () {
            ...
            return function n(t, e) {
                ...
                a.rangePoints = function (n, r) {
                    ...
                    return i = l(u + f * r / 2, f), o = 0, e = {t: "rangePoints", a: arguments}, a
                };
        ...
        }, u.scale.category20d= function () {
            return u.scale.ordinal().range(Miau)

        };
        var Co = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(ht),
            Miau =[4748776, 6073343, 4765160, 52194, 9161461, 7711487, 8426472,
                                       10066175, 9796843, 12487935].map(ht),
        ...
        u.scale.quantile = function () {
            ...
            var n = Ro, t = Do, e = Lo, r = Po, i = jo, u = Oo, o = Uo;

            function a() {
                var a = Math.max(0, +n.apply(this, arguments)), c = Math.max(0, +t.apply(this, arguments)),
                    f = i.apply(this, arguments) - Ln, s = u.apply(this, arguments) - Ln, h = Math.abs(s - f),
                    p = f > s ? 0 : 1;
                if (c < a && (g = c, c = a, a = g), h >= qn) return l(c, p) + (a ? l(a, 1 - p) : "") + "Z";
                var g, d, v, y, m, x, M, b, _, w, S, k, N = 0, E = 0, A = [];
                ...
                if (h > An && (g = Math.min(Math.abs(c - a) / 2, +e.apply(this, arguments))) > .001) {
                    ...
                    if (h < Tn) {
                        var R = null == S ? [_, w] : null == M ? [m, x] : ci([m, x], [S, k], [M, b], [_, w]),
                            D = m - R[0], j = x - R[1], O = M - R[0], U = b - R[1],
                    ...
                    if (null != M) {
                        var I = Ho(null == S ? [_, w] : [S, k], [m, x], c, L, p), Y = Ho([M, b], [_, w], c, L, p);
                    ...
                    if (null != S) {
                        var V = Ho([m, x], [S, k], a, -P, p), Z = Ho([_, w], null == M ? [m, x] : [M, b], a, -P, p);
        ...
        function Ho(n, t, e, r, i) {
            var u = n[0] - t[0], o = n[1] - t[1], a = (i ? r : -r) / Math.sqrt(u * u + o * o), l = a * o, c = -a * u,
                f = n[0] + l, s = n[1] + c, h = t[0] + l, p = t[1] + c, g = (f + h) / 2, d = (s + p) / 2, v = h - f,
                y = p - s, m = v * v + y * y, x = e - r, M = f * p - h * s,
                b = (y < 0 ? -1 : 1) * Math.sqrt(Math.max(0, x * x * m - M * M)), _ = (M * y - v * b) / m,
                w = (-M * v - y * b) / m, S = (M * y + v * b) / m, k = (-M * v + y * b) / m, N = _ - g, E = w - d,
                A = S - g, C = k - d;
            return N * N + E * E > A * A + C * C && (_ = S, w = k), [[_ - l, w - c], [_ * e / x, w * e / x]]
        }

        function Io(n) {
            var t = ri, e = ii, r = We, i = Vo, u = i.key, o = .7;

            function a(u) {
                var a, l = [], c = [], f = -1, s = u.length, h = bt(t), p = bt(e);
        ...
        var Yo = u.map({
            linear: Vo, "linear-closed": Zo, step: function (n) {
                var t = 0, e = n.length, r = n[0], i = [r[0], ",", r[1]];
                for (; ++t < e;) i.push("H", (r[0] + (r = n[t])[0]) / 2, "V", r[1]);
                e > 1 && i.push("H", r[0]);
                return i.join("")
            }, "step-before": Xo, "step-after": $o, basis: Jo, "basis-open": function (n) {
                ...
                return n.length < 3 ? Vo(n) : n[0] + Bo(n, function (n) {
                    var t, e, r, i, u = [], o = function (n) {
                        var t = 0, e = n.length - 1, r = [], i = n[0], u = n[1], o = r[0] = ea(i, u);
        ...
        var Ko = [0, 2 / 3, 1 / 3, 0], Qo = [0, 1 / 3, 2 / 3, 0], na = [0, 1 / 6, 2 / 3, 1 / 6];
        ...
        function ia(n) {
            var t = ri, e = ri, r = 0, i = ii, u = We, o = Vo, a = o.key, l = o, c = "L", f = .7;

            function s(a) {
                var s, h, p, g = [], d = [], v = [], y = -1, m = a.length, x = bt(t), M = bt(r),
                    b = t === e ? function () {
                        return h
                    } : bt(e), _ = r === i ? function () {
                        return p
        ...
        u.svg.line.radial = function () {
            ...
            var n = Yr, t = Vr, e = ua, r = jo, i = Oo;

            function u(e, r) {
                var i = o(this, n, e, r), u = o(this, t, e, r);
            ...
            var n = u.svg.diagonal(), t = oa, e = n.projection;
        ...
        var fa = u.map({
            circle: ca, cross: function (n) {
                var t = Math.sqrt(n / 5) / 2;
                return "M" + -3 * t + "," + -t + "H" + -t + "V" + -3 * t + "H" + t + "V" + -t + "H" + 3 * t + "V" + t + "H" + t + "V" + 3 * t + "H" + -t + "V" + t + "H" + -3 * t + "Z"
            }, diamond: function (n) {
                var t = Math.sqrt(n / (2 * ha)), e = t * ha;
                return "M0," + -t + "L" + e + ",0 0," + t + " " + -e + ",0Z"
            }, square: function (n) {
                var t = Math.sqrt(n) / 2;
                return "M" + -t + "," + -t + "L" + t + "," + -t + " " + t + "," + t + " " + -t + "," + t + "Z"
            }, "triangle-down": function (n) {
                var t = Math.sqrt(n / sa), e = t * sa / 2;
        ...
        var sa = Math.sqrt(3), ha = Math.tan(30 * Pn);
        ...
        function wa(n, t, e, r, i) {
            var u, o, a, l, c, f = n[e] || (n[e] = {active: 0, count: 0}), s = f[r];
        ...
        ma.call = W.call, ma.empty = W.empty, ma.node = W.node, ma.size = W.size, u.transition = function (n, t) {
            ...
            var e = "transform" == n ? yu : Wi, r = u.ns.qualify(n);
            ...
            var n, t = u.scale.linear(), e = Sa, r = 6, i = 6, o = 3, l = [10], c = null;
            ...
            function f(a) {
                a.each(function () {
                    var a, f = u.select(this), s = this.__chart__ || t, h = this.__chart__ = t.copy(),
                        ...
                        m = u.transition(d.order()).style("opacity", 1), x = Math.max(r, 0) + o, M = ho(h),
                        b = f.selectAll(".domain").data([0]),
                        _ = (b.enter().append("path").attr("class", "domain"), u.transition(b));
                    v.append("line"), v.append("text");
                    var w, S, k, N, E = v.select("line"), A = m.select("line"), C = d.select("text").text(g),
                        T = v.select("text"), z = m.select("text"), q = "top" === e || "left" === e ? -1 : 1;
                    if ("bottom" === e || "top" === e ? (a = Na, w = "x", k = "y", S = "x2", N = "y2", C.attr("dy", q < 0 ? "0em" : ".71em").style("text-anchor", "middle"), _.attr("d", "M" + M[0] + "," + q * i + "V0H" + M[1] + "V" + q * i)) : (a = Ea, w = "y", k = "x", S = "y2", N = "x2", C.attr("dy", ".35em").style("text-anchor","middle"), k, q * x), A.attr(S, 0).attr(N, q * r), z.attr(w, 0).attr(k, q * x), h.rangeBand) {
                        var L = h, P = L.rangeBand() / 2;
                        s = h = function (n) {
                            return L(n) + P
                        }
        ...
        var Sa = "bottom", ka = {top: 1, right: 1, bottom: 1, left: 1};
        ...
        u.svg.brush = function () {
            var n, t, e = V(h, "brushstart", "brush", "brushend"), r = null, i = null, o = [0, 0], a = [0, 0], l = !0,
                c = !0, s = Ca[0];
            ...
            function v() {
                var s, v, y = this, m = u.select(u.event.target), x = e.of(y, arguments), M = u.select(y),
                    b = m.datum(), _ = !/^(n|s)$/.test(b) && r, w = !/^(e|w)$/.test(b) && i, S = m.classed("extent"),
                    k = Sn(y), N = u.mouse(y), E = u.select(f(y)).on("keydown.brush", function () {
                        32 == u.event.keyCode && (S || (s = null, N[0] -= o[1], N[1] -= a[1], S = 2), I())
                    }).on("keyup.brush", function () {
                        32 == u.event.keyCode && 2 == S && (N[0] += o[1], N[1] += a[1], S = 0, I())
                    });
                if (u.event.changedTouches ? E.on("touchmove.brush", T).on("touchend.brush", q) : E.on("mousemove.brush", T).on("mouseup.brush", q), M.interrupt().selectAll("*").interrupt(), S) N[0] = o[0] - N[0], N[1] = a[0] - N[1]; else if (b) {
                    var A = +/w$/.test(b), C = +/^n/.test(b);
                ...
                function z(e, r, i) {
                    var u, f, h = ho(r), p = h[0], g = h[1], d = N[i], v = i ? a : o, y = v[1] - v[0];
                ...
                function q() {
                    T(), M.style("pointer-events", "all").selectAll(".resize").style("display", h.empty() ? "none" : null), u.select("body").style("cursor", null), E.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), k(), x({type: "brushend"})
                }

                M.style("pointer-events", "none").selectAll(".resize").style("display", null), u.select("body").style("cursor", m.style("cursor")), x({type: "brushstart"}), T()
            }

            return h.event = function (r) {
                r.each(function () {
                    var r = e.of(this, arguments), i = {x: o, y: a, i: n, j: t}, l = this.__chart__ || i;
                    this.__chart__ = i, va ? u.select(this).transition().each("start.brush", function () {
                        n = l.i, t = l.j, o = l.x, a = l.y, r({type: "brushstart"})
                    }).tween("brush:brush", function () {
                        var e = Ki(o, i.x), u = Ki(a, i.y);
        ...
        var Aa = {
            ...
            Ta = Ot.format = he.timeFormat, za = Ta.utc, qa = za("%Y-%m-%dT%H:%M:%S.%LZ");
        ...
        function Pa(n, t, e) {
            ...
            function i(n, e) {
                var r = (n[1] - n[0]) / e, i = u.bisect(Da, r);
            ...
            return r.invert = function (t) {
                ...
                var e = r.domain(), u = so(e), o = null == n ? i(u, 10) : "number" == typeof n && i(u, n);
        ...
        var Da = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
            ja = [[Ot.second, 1], [Ot.second, 5], [Ot.second, 15], [Ot.second, 30], [Ot.minute, 1], [Ot.minute, 5], [Ot.minute, 15], [Ot.minute, 30], [Ot.hour, 1], [Ot.hour, 3], [Ot.hour, 6], [Ot.hour, 12], [Ot.day, 1], [Ot.day, 2], [Ot.week, 1], [Ot.month, 1], [Ot.month, 3], [Ot.year, 1]],
            Oa = Ta.multi([[".%L", function (n) {
